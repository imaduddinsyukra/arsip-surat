<?php
$queryy2 = mysql_query("SELECT * FROM image_content where category_content = 'Why'"); //get the data that will be updated
            ...
            <div class="container">
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-12 m-auto text-white">
                        ...
                        <h1><font color="white"><b> Why Choose Maritim Dua Satu </b></font></h1>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent">
                                ...
                                <li class="breadcrumb-item active"><a href="index2.php?part=page-services-why"><font color="white">Why Choose Us</font></a></li>
                                </li>
                            </ol>
                        </nav>
                   ...
                   <div class="col-lg-12">
                    ...
                    <div class="card m-b-30 bg-dark text-white">
                        <div class="card-body ">
                            ...
                            <input type="hidden" name="parm" value="add_image_why_bos">
                    ...
                    <div class="card-body">
                         <a href="index2.php?part=add-services-why" type="button" class="btn btn-success"><font color="white">Add Data</font></a>
                            <div class="table-responsive p-t-10">
                                ...
                                <?php
                                    $no = 1;
                                    $query = mysql_query("SELECT * from content where category_content = 'Why'");
                                ...
                                ?>   
                                    <tr>
                                        ...
                                        <form action="index2.php?part=aksi-page-services" method="post" onClick="return confirm('Apakah Anda Yakin Hapus Data?')">
                                            <input type="hidden" name="parm" value="delete_item_why_bos">
