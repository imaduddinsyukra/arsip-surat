            ...
            <div class="container">
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-12 m-auto text-white">
                        ...
                        <h1><font color="white"><b> Add Why Choose Us </b></font></h1>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent">
                                ...
                                <li class="breadcrumb-item"><a href="index2.php?part=page-services-why"><font color="white">Why Choose Us</font></a></li>
                                <li class="breadcrumb-item active"><a href="index2.php?part=add-services-why"><font color="white">Add</font></a></li>
                            </ol>
                        </nav>
                   ...
                   <div class="col-lg-12">
                    ...
                    <div class="card m-b-30 bg-dark text-white">
                        <div class="card-body ">
                            ...
                            <input type="hidden" name="parm" value="services_why_bos">
                                
                                <div class="form-row">
                                     <div class="form-group col-md-12">
                                        <label>Why Choose Us?</label><br>
