            ...
            <div class="container">
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-12 m-auto text-white">
                        ...
                        <h1><font color="white"><b>Our Gallery </b></font></h1>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent">
                                ...
                                <li class="breadcrumb-item active"><a href="index2.php?part=page-about-gallery"><font color="white">Gallery</font></a></li>
                                </li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                         <a href="index2.php?part=add-about-gallery" type="button" class="btn btn-success"><font color="white">Add Gallery</font></a>
                            <div class="table-responsive p-t-10">
                                ...
                                <?php
                                    $no = 1;
                                    $query = mysql_query("SELECT * from image_content where category_content='Gallery' order by id_image desc");
                                ...
                                ?>   
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="index2.php?part=aksi-page-about" method="post"  onClick="return confirm('Apakah Anda Yakin Mengganti Status?')">
                                            <input type="hidden" value="change_gallery_bos" name="parm">
                                        ...
                                        <form action="index2.php?part=aksi-page-about" method="post" onClick="return confirm('Apakah Anda Yakin Hapus Data?')">
                                            <input type="hidden" name="parm" value="delete_gallery_bos">
                                            <input type="hidden" value="<?=$dt['id_image'];?>" name="idnya">
