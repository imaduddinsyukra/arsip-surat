<?php
$queryy = mysql_query("SELECT * FROM content where category_content = 'Vision'"); //get the data that will be updated
$dt=mysql_fetch_array($queryy);

$queryy2 = mysql_query("SELECT * FROM image_content where category_content = 'Vision'"); //get the data that will be updated
            ...
            <div class="container">
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-12 m-auto text-white">
                        ...
                        <h1><font color="white"><b> Maritim Dua Satu Vision</b></font></h1>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent">
                                ...
                                <li class="breadcrumb-item active"><a href="index2.php?part=page-about-vision"><font color="white">Vision</font></a>
                                </li>
                            </ol>
                        </nav>
                   ...
                   <div class="col-lg-12">
                    ...
                    <div class="card m-b-30 bg-dark text-white">
                        <div class="card-body ">
                            ...
                            <input type="hidden" name="parm" value="vision_bos">
