...
<!-- Mirrored from atmos.atomui.com/neo/login by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jul 2019 03:35:46 GMT -->
...
<title>Login Admin Panel - Maritim Dua Satu</title>
...
<main class="admin-main  ">
    <div class="container-fluid">
        <div class="row ">
            <div class="col-lg-4  bg-white">
                <div class="row align-items-center m-h-100">
                    <div class="mx-auto col-md-8">
                        ...
                        <p class="admin-brand-content" style="font-size: 14pt;">
                               Maritim Security Service
                            </p>
                           <!--  <p>Maritim Dua Satu Security Service</p> -->
                            <p>
                                <img src="assets/img/logo-maritim.png" width="80" alt="">
                        ...
                        <form class="needs-validation" action="log_process.php" method="post">
                            <div class="form-row">
            ...
            <div class="col-lg-8 d-none d-md-block bg-cover" style="background-image: url('assets/img/log-banner.jpg');">
