      ...
      <div class="container">
        <div class="row section-title justify-content-center text-center">
          <div class="col-md-9 col-lg-8 col-xl-7">
            <h2 class="display-4">News and Insight</h2>
          </div>
        </div>
        <div class="row">
          <div class="col">
...
$limitStart = ($page - 1) * $limit;
    ...
    $query = mysql_query("SELECT * from tbl_berita join user where user.id_user = tbl_berita.pengirim_berita order by id_berita desc limit ".$limitStart.",".$limit);
