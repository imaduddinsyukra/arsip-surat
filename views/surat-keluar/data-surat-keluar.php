        ...
        <div class="card-header">
          ...
          <div class="card-body">
              <div class="table-responsive">
                <a href="admin.php?part=tambah-surat-keluar" class="btn btn-success mb-3"><i class="fa fa-plus" style="color: white"></i> <font size="3" color="white"><u>Tambah Data</u></font></a>
              <br>
                <?php
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  ?>              
                    <tr>
                      ...
                      <td align="center">
                        <a href="admin.php?part=ubah-surat-keluar&id_surat_keluar=<?= $data['id_surat_keluar']; ?>" class="btn btn-warning mb-3"> <i class="fa fa-fw fa-pencil" style="color: white"></i> <font color="white">Edit</font></a>
                      </td>
                    </tr>
                  <?php
                    }
