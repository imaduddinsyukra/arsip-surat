...
h1 {
 ...
 <body>
 <h2 align="Center">Laporan Surat Keluar Bulan <?= $_GET['bulan'];?> Tahun <?= $tahun;?></h2>
...
<table border="1" width="100%">
    <thead>
        <tr>
            ...
            <th width="10%"><p align="center">Tujuan</th>
            <th width="10%"><p align="center">Tanggal Arsip</th>
            <th width="10%"><p align="center">Diarsip Oleh</th>
    ...
    <tbody>
        <?php
            $no = 1;
            $query = mysql_query("select * from tbl_surat_keluar join tbl_user using (id_user) where month(tgl_catat) = '$bulan' and year(tgl_catat) = '$tahun'");
        ...
        <tr>
            ...
            <td align="center"><?php echo $dt['tgl_catat'];?></td>
...
$mpdf->SetTitle("Laporan Surat Keluar");$mpdf->SetDisplayMode('fullpage');
$mpdf->setHTMLHeader($header);
$mpdf->setHTMLFooter($footer);
$stylesheet = file_get_contents('../../assets/mpdf/mpdf.css');
$mpdf->WriteHTML($stylesheet,1);
$mpdf->WriteHTML($out);
$mpdf->Output("Laporan Surat Keluar Bulan $bulan Tahun $tahun.pdf", 'I');
?>
</body>
</html>