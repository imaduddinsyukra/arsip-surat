    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#">Disposisi Lanjutan Surat</a>
        </li>
        <li class="breadcrumb-item active">Data Disposisi Lanjutan Surat</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabel Data Disposisi Lanjutan Surat</div>
        <div class="card-body">
...
<?php
  include ("../config/koneksi.php");
    ...
    $sqll = "select * from tbl_disposisi where id_user = '$id_user' order by id_disposisi desc";
