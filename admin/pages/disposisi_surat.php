...
?>              
                <tr>
                  ...
                  ?>
                    <a href="index.php?p=tambah_disposisi_surat_masuk&id_surat_masuk=<?php echo $cek['id_surat_masuk']; ?>&kd=2" class="btn btn-success mb-3"> <i class="fa fa-fw fa-clipboard" style="color: white"></i> <font color="white">Tambah Disposisi</font></a>
                  <?php } elseif($data['jenis_surat']=="Surat Keluar") { ?>
                  <?php 
                    $que=mysql_query("select * from tbl_surat_keluar where no_surat='$no_surat'");
                    $cek = mysql_fetch_array($que);
                  ?>
                    <a href="index.php?p=tambah_disposisi_surat_keluar&id_surat_keluar=<?php echo $cek['id_surat_keluar']; ?>&kd=2" class="btn btn-success mb-3"> <i class="fa fa-fw fa-clipboard" style="color: white"></i> <font color="white">Tambah Disposisi</font></a>
                  <?php } ?>
