  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Tambah Data Disposisi Surat Masuk</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-clipboard"></i> Form Tambah Data Disposisi Surat Masuk</div>
        <div class="card-body">
          <div class="table-responsive">
 

<form action="index.php?p=prosestambahdisposisimasuk" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type='text' name='jenis_surat' class="form-control" required value="Surat Masuk" readonly="">
    </div>
    <div class="form-group mb-4">
        <label>Tujuan *</label>
    ...
    <input type='hidden' name='id_surat_masuk' value="<?php echo $id; ?>" required>   
