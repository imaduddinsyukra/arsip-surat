    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <a href="index.php?p=tambah_surat_keluar" class="btn btn-success mb-3"><i class="fa fa-plus" style="color: white"></i> <font size="3" color="white"><u>Tambah Data</u></font></a></div><br>

            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
<?php
  include ("../config/koneksi.php");
  $sqll = "select * from tbl_surat_keluar order by id_surat_keluar desc";
...
?>            
              <thead>
                <tr>
                    ...
                    <th colspan="4"><p align="center">Pilihan</p></th>       
                </tr>
                <tr>
...
?>              
                <tr>
                  ...
                  <td align="center">
                    <a href="index.php?p=detail_keluar&id_surat_keluar=<?php echo $data['id_surat_keluar']; ?>" class="btn btn-success mb-3"> <i class="fa fa-fw fa-eye" style="color: white"></i> <font color="white">Detail</font></a>
                  </td>
                  ...
                  <?php } else { ?>
                    <a href="index.php?p=tambah_disposisi_surat_keluar&id_surat_keluar=<?php echo $data['id_surat_keluar']; ?>&kd=1" class="btn btn-primary mb-3"> <i class="fa fa-fw fa-clipboard" style="color: white"></i> <font color="white">Tambah Disposisi</font></a>
                  <?php } ?>
                  </td>

                  <td align="center">
                    <a href="index.php?p=edit_surat_keluar&id_surat_keluar=<?php echo $data['id_surat_keluar']; ?>" class="btn btn-warning mb-3"> <i class="fa fa-fw fa-pencil" style="color: white"></i> <font color="white">Edit</font></a>
                  </td>
                  <!-- <td align="center">
