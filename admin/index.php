...
<head>
  ...
  <!-- CSS FOTO -->
  <link href="../assets/css/style-foto.css" rel="stylesheet">
  <!-- DROPIFY -->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php?p=home"><img src="../assets/logo.png" width="10%"> &nbsp; Sistem Informasi Pengarsipan Surat</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Surat Masuk">
          <a class="nav-link" href="index.php?p=surat_masuk">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Surat Keluar">
          <a class="nav-link" href="index.php?p=surat_keluar">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Surat Keluar">
          <a class="nav-link" href="index.php?p=disposisi">
...
<!-- ====================================== END BODY ====================================== -->
    ...
    <!-- JS FOTO -->
    <script src="../assets/js/js-foto.js"></script>
    <!-- DROPIFY -->
